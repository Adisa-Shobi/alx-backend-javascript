...
describe('tests for the upgraded calculateNumber function', () => {
  ...
  describe('test for SUM operation with two floats', () => {
    it('should equal 6', () => {
      expect(calculateNumber('SUM', 2.6, 3.2)).to.equal(6);
    });
  });

  describe('test for SUM operation with first val floats', () => {
    it('should equal 6', () => {
      expect(calculateNumber('SUM', 2.6, 3)).to.equal(6);
    });
  });
  ...
  describe('test for SUBTRACT operation with two floats one bordeline',
    () => {
      it('should equal 0', () => {
        expect(calculateNumber('SUBTRACT', 2.5, 3.2)).to.equal(0);
      });
    });

  describe('test for SUBTRACT operation first val float', () => {
    it('should equal 5', () => {
      expect(calculateNumber('SUBTRACT', 8.3, 3)).to.equal(5);
    });
  });

  describe('test for SUBTRACT operation second val float', () => {
    it('should equal 4', () => {
      expect(calculateNumber('SUBTRACT', 8, 3.5)).to.equal(4);
    });
  });
  ...
  describe('test for DIVIDE operation with two floats', () => {
    it('should equal 4', () => {
      expect(calculateNumber('DIVIDE', 12.3, 2.5)).to.equal(4);
    });
  });
});
